...
public class FigurPanel extends JPanel {
  private FigurGraphics graphics;
  ...
  public FigurPanel(FigurenListe figList, FigurController controller) {
    ...
    graphics = new FigurGraphics(figList);
    this.add(graphics);
  ...
  public void setGraphics(FigurGraphics graphics) {
  ...
  public JTextField[] getTfWerte() {
    return tfWerte;
  }

  public void setTfWerte(JTextField[] tfWerte) {
    this.tfWerte = tfWerte;
  }
